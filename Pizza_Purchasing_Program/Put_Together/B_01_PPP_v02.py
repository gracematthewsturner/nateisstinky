...
def menu():
    ...
    print(f'''
Code Pizza Type Availability

1 | Pepperoni | Traditional($5) | {random.randint(1, 5)}
2 | Cheese |  | {random.randint(1, 5)}
3 | Hawaiian |  | {random.randint(1, 5)}
4 | Margarita |  | {random.randint(1, 5)}
5 | Vegetarian |  | {random.randint(1, 5)}
6 | Chicken | Gourmet($10) | {random.randint(1, 5)}
7 | Chicken Again |  | {random.randint(1, 5)}
8 | Artichoke |  | {random.randint(1, 5)}
9 | Truffle |  | {random.randint(1, 5)}
10 | Seafood |  | {random.randint(1, 5)}
''')
